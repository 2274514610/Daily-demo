      ...
      .then(
        ([
          ...
          var tileLayer = new VectorTileLayer({
            ...
            id: "vectorTileLayer",
            url:
              "https://abi.arcgisonline.cn/server/rest/services/Hosted/InlandENC_VT_CGCS2000/VectorTileServer",
            // url: 'https://zhongrong.arcgisonline.cn/server/rest/services/Hosted/InlandENC_VT_CGCS2000/VectorTileServer',
            visible: true
          });
          map.add(tileLayer);
